                ...
                <div className="flex justify-between items-center max-w-sm mx-auto">
                    ...
                    <Link to={'/home'}
                        className={`flex flex-col items-center gap-1 p-2 transition-colors duration-200 ${
                            isActive('/home') ? "text-pink-500 font-semibold" : "hover:text-pink-500"
                        }`}>
                    ...
                    <Link to={'/library'}
                        className={`flex flex-col items-center gap-1 p-2 transition-colors duration-200 ${
                            isActive('/library') ? "text-pink-500 font-semibold" : "hover:text-pink-500"
                        }`}>
                    ...
                    <Link to={'/profile'}
                        className={`flex flex-col items-center gap-1 p-2 transition-colors duration-200 ${
                            isActive('/profile') ? "text-pink-500 font-semibold" : "hover:text-pink-500"
                        }`}>
